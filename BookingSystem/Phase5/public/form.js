...
// 409 = duplicate resourceName
    if (response.status === 409) {
      const msg = "⚠️ This resource name is already in use.\n\nPlease choose a unique name or check the existing list of resources.";
      showFormMessage("info", msg); // "info" käyttää keltaista tyyliä, mikä sopii tähän hyvin
      return;
      }
    ...
    const msg = `✅ Success! "${resourceName}" has been added.\n\nThe resource is now stored in the database and available for bookings.`;

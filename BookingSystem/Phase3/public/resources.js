...
let updateButton = null; // Lisätty määrittely
let deleteButton = null; // Lisätty määrittely
...
function renderActionButtons(currentRole) {
  actions.innerHTML = ""; // Clear existing buttons before rendering new ones
if (currentRole === "reserver" || currentRole === "admin") {
    createButton = addButton({
      label: "Create",
      type: "submit",
      value: "create", // Lisätty value myös reserverille
...
// Tarkistetaan olemassaolo ennen disablointia (vältetään null-virheet)
